...
$config = array(
	...
	'default-sp' => array(
		'cas:CAS',
		'cas' => array(
			'login' => 'https://login.uiowa.edu/uip/login.page',
			'validate' => 'https://login.uiowa.edu/uip/checkticket.page',
			'logout' => 'https://login.uiowa.edu/uip/logout.page?service=http://localhost:8888/hawkid-ss/Security/loggedout',
			'attributes' => 'hawkid',
		),
		'ldap' => array(
			'servers' => 'ldap://directory.iowa.uiowa.edu:389',
			'enable_tls' => false,
			'searchbase' => 'OU=people,DC=metadirectory,DC=iowa,DC=uiowa,DC=edu',
			'searchattributes' => 'uiowaHawkID',
			'attributes' => array('uiowaHawkID', 'mail'),
